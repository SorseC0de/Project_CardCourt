...
| **Snow Ball** | Variaball | SHOT −10% each time it's passed, stacking. Blaze Ball's opposite number, same independence from other pass modifiers. Retires Ice Wrap's freed name | 5 |
